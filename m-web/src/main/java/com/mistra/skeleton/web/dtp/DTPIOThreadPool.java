 ...
 */
@Slf4j
public class DTPIOThreadPool extends DTPThreadPool {

    public DTPIOThreadPool(Integer corePoolSize, Integer poolQueueSize, EnableDiversityThreadPool annotation) {
    ...
    void init(Integer corePoolSize, Integer poolQueueSize, EnableDiversityThreadPool annotation) {
        threadPoolExecutor = new ThreadPoolExecutor(
                Math.min(availableProcessors, corePoolSize) * 2,
                Math.min(availableProcessors, corePoolSize) * 2,
